...
::: {.notes}
Como objetivo secundario, aprenderemos también a utilizar un poco Rstudio
:::
...
-   `CMD` + `TAB`: Cambiar entre ventanas de MAC
...
::: {.container}
::: {.col style="width:20%"}
`r img(alt = "Logo Stata", src = LOGO_STATA, height = IMG_HEIGHT_ATTR)`
:::
::: {.col style="width:80%"}
...
::: {.container}
::: {.col style="width:20%"}
`r img(alt = "'Under construction' icon", src = ICON_CONSTRUCTION, height = IMG_HEIGHT_ATTR)`
:::
::: {.col style="width:80%"}
